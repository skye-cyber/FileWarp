...
export const DocumentTool = ({ }) => {
    return (
        <section>
            <div id="tool-convert_doc" className="tool-interface hidden">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="flex gap-2 text-xl font-semibold text-gray-900 dark:text-white">
                        <svg className="h-6 w-6 fill-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M566.6 214.6L470.6 310.6C461.4 319.8 447.7 322.5 435.7 317.5C423.7 312.5 416 300.9 416 288L416 224L96 224C78.3 224 64 209.7 64 192C64 174.3 78.3 160 96 160L416 160L416 96C416 83.1 423.8 71.4 435.8 66.4C447.8 61.4 461.5 64.2 470.7 73.3L566.7 169.3C579.2 181.8 579.2 202.1 566.7 214.6zM169.3 566.6L73.3 470.6C60.8 458.1 60.8 437.8 73.3 425.3L169.3 329.3C178.5 320.1 192.2 317.4 204.2 322.4C216.2 327.4 224 339.1 224 352L224 416L544 416C561.7 416 576 430.3 576 448C576 465.7 561.7 480 544 480L224 480L224 544C224 556.9 216.2 568.6 204.2 573.6C192.2 578.6 178.5 575.8 169.3 566.7z" /></svg>Document Conversion
                    </h3>
                    <span
                ...
                <form id="doc-convert-form" className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center">
                                    ...
                                    >Use alternative conversion method</span
                                    >
                                </label>
                                <label className="flex items-center">
                                    <input
                                    ...
                                    />
                                    <span className="ml-2 text-sm text-gray-700 dark:text-gray-300"
                                    >Preserve original quality</span
                                    >
                                </label>
                            </div>
                        </div>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <div
                            ...
                            onclick="toggleAdvanced('doc-advanced')"
                        >
                        ...
                        <div id="doc-advanced" className="mt-3 hidden space-y-3">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full p-2 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-600"
                                    />
                                </div>
                                <div>
                                    <label className="block text-xs text-gray-600 dark:text-gray-400 mb-1"
                    ...
                    <div className="flex space-x-4">
                        ...
                        >
                            <span className="flex justify-center items-center gap-2">
                                <svg className="h-5 w-5 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M259.1 73.5C262.1 58.7 275.2 48 290.4 48L350.2 48C365.4 48 378.5 58.7 381.5 73.5L396 143.5C410.1 149.5 423.3 157.2 435.3 166.3L503.1 143.8C517.5 139 533.3 145 540.9 158.2L570.8 210C578.4 223.2 575.7 239.8 564.3 249.9L511 297.3C511.9 304.7 512.3 312.3 512.3 320C512.3 327.7 511.8 335.3 511 342.7L564.4 390.2C575.8 400.3 578.4 417 570.9 430.1L541 481.9C533.4 495 517.6 501.1 503.2 496.3L435.4 473.8C423.3 482.9 410.1 490.5 396.1 496.6L381.7 566.5C378.6 581.4 365.5 592 350.4 592L290.6 592C275.4 592 262.3 581.3 259.3 566.5L244.9 496.6C230.8 490.6 217.7 482.9 205.6 473.8L137.5 496.3C123.1 501.1 107.3 495.1 99.7 481.9L69.8 430.1C62.2 416.9 64.9 400.3 76.3 390.2L129.7 342.7C128.8 335.3 128.4 327.7 128.4 320C128.4 312.3 128.9 304.7 129.7 297.3L76.3 249.8C64.9 239.7 62.3 223 69.8 209.9L99.7 158.1C107.3 144.9 123.1 138.9 137.5 143.7L205.3 166.2C217.4 157.1 230.6 149.5 244.6 143.4L259.1 73.5zM320.3 400C364.5 399.8 400.2 363.9 400 319.7C399.8 275.5 363.9 239.8 319.7 240C275.5 240.2 239.8 276.1 240 320.3C240.2 364.5 276.1 400.2 320.3 400z" /></svg>Convert Documents
                            </span>
                        </button>
                        <button
                            type="button"
                            onclick="clearForm('doc-convert-form')"
            ...
            {/* PDF Joining Tool */}
            <div id="tool-pdf_join" className="tool-interface hidden">
                <div className="flex items-center justify-between mb-6">
            ...
            {/* PDF Text Extraction */}
            <div id="tool-scan_pdf" className="tool-interface hidden">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="flex items-center gap-2 text-xl font-semibold text-gray-900 dark:text-white">
            ...
            {/* PDF to long Image */}
            <div id="tool-doc_long_image" className="tool-interface hidden">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="flex items-center gap-2 text-xl font-semibold text-gray-900 dark:text-white">
      ...
      <div id="doc_long_image-advanced" className="mt-3 hidden space-y-3">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <div id="tool-extract_pages" className="tool-interface hidden">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="flex items-center gap-2 text-xl font-semibold text-gray-900 dark:text-white">
            ...
            {/* Doc to Images */}
            <div id="tool-doc2image" className="tool-interface hidden">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="flex items-center gap-2 text-xl font-semibold text-gray-900 dark:text-white">
